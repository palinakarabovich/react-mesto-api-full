            ...
            <section className="profile page__center">
                <div className="profile__content">
                    <div className="profile__pic">
                        ...
                        <button className="profile__avatar-edit-button" aria-label="Изменить аватар" onClick={onEditAvatar}></button>
                    </div>
                    <div className="profile__info">
                        <div className="profile__info-row">
                            <h1 className="profile__info-name">{currentUser.name}</h1>
                            <button className="profile__info-edit-button" type="button" aria-label="Изменить описание профиля" onClick={onEditProfile}></button>
                        </div>
                        <p className="profile__info-caption">{currentUser.about}</p>
                    </div>
                </div>
                <button className="profile__add-photo-button" type="button" aria-label="Добавить фото" onClick={onAddPlace}></button>
            </section>
